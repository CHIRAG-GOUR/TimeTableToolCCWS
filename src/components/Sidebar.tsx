...
export default function Sidebar() {
  ...
  return (
    <aside className="fixed left-0 top-0 z-40 h-screen w-64 border-r border-orange-900/10 bg-gradient-to-b from-orange-700 to-orange-800 text-white transition-colors print:hidden">
      <div className="flex h-full flex-col px-3 py-4">
        <div className="mb-10 flex items-center px-4 pt-2">
